    ...
    return (
        <section id='home' className='w-full p-2 flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container '>
            <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28'>
                ...
                <h1 className='mt-10 font-palanquin text-[80px] max-sm:text-[72px] sm:leading-[82px] font-bold'>
            ...
            <div className='relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-cover bg-hero bg-center'>
                <img src={bigShoeImg} alt="Shoe Colleciton" width={610} height={500} className='object-contain relative z-10' />
                <div className=' absolute flex sm:gap-6 gap-4 bottom-[-5%] sm:left-[10%] max-sm:px-6'>
                    {shoes.map((shoe, index) => (
                        <div key={shoe} className=''>
                            ...
                            <ShoeCard
                                imgURL={shoe}
                                changeBigShoeImg={(sh) => { setBigShoeImg(sh) }}
